...
tradeoff.fit.function <- function(data, epsilon) {
    ...
    if (results$convergence != 0) {
        warning("Tradeoff Fitting function failed to converge")
    }
...
exponential.fit.function <- function(data, epsilon) {
    ...
    results <- optim(
        c(1.0, 0.5),
        f,
        method="BFGS", #Before "L-BFGS-B" but it didnt converged
...
#        upper=c(500.00, 0.99),
    ...
    if (results$convergence != 0) {
        warning("Exponential Fitting function failed to converge")
    }
...
#        upper=c(500.00, 100.00),
    ...
    if (results$convergence != 0) {
        warning("Hyperbolic Fitting function failed to converge")
    }
...
#        upper=c(500.00, 0.99, 0.99),
    ...
    if (results$convergence != 0) {
        warning("quasi hyperbolic Fitting function failed to converge")
    }
...
generalized.hyperbolic.fit.function <- function(data, epsilon)
{
    ...
    if (results$convergence != 0) {
        warning("Gen. hyperbolic Fitting function failed to converge")
    }
...
homothetic.exponential.fit.function <- function(data, epsilon) {
    ...
    if (results$convergence != 0) {
        warning("Homothe. Exponential Fitting function failed to converge")
    }
...
homothetic.hyperbolic.fit.function <- function(data, epsilon) {
    ...
    if (results$convergence != 0) {
        warning("Homothe. hyperbolic Fitting function failed to converge")
    }
...
homothetic.quasihyperbolic.fit.function <- function(data, epsilon) {
    ...
    if (results$convergence != 0) {
        warning("homo quasihyp. Fitting function failed to converge")
    }
...
homothetic.generalized.hyperbolic.fit.function <- function(data, epsilon) {
    ...
    if (results$convergence != 0) {
        warning("homotheotic gen hyp. Fitting function failed to converge")
    }
